...
function store_customize_register_misc($wp_customize) {
    ...
    $wp_customize->add_control(
        new WP_Customize_Upgrade_Control(
            ...
            'store_pro',
            array(
                'description'	=> '<a class="store-important-links" href="https://inkhive.com/contact-us/" target="_blank">'.__('InkHive Support Forum', 'store').'</a>
                                    <!----<a class="store-important-links" href="https://inkhive.com/documentation/store" target="_blank">'.__('Store Documentation', 'store').'</a> ---->
                                    <a class="store-important-links" href="https://demo.inkhive.com/store-plus/" target="_blank">'.__('Store Plus Live Demo', 'store').'</a>
